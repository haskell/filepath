...
tests =
    ...
    ,("getParse parseUNCShare \"\" === Nothing", property $ getParse parseUNCShare "" === Nothing)
    ,("getParse parseUNCShare \"\" === Nothing", property $ getParse parseUNCShare "" === Nothing)
    ,("getParse parseUNCShare \"text.txt\" === Nothing", property $ getParse parseUNCShare "text.txt" === Nothing)
    ,("getParse parseUNCShare \"text.txt\" === Nothing", property $ getParse parseUNCShare "text.txt" === Nothing)
    ,("getParse parseUNCShare \"\\\\\\\\/localhost/////\\\\share\" === Nothing", property $ getParse parseUNCShare "\\\\/localhost/////\\share" === Nothing)
    ,("getParse parseUNCShare \"\\\\\\\\/localhost/////\\\\share\" === Nothing", property $ getParse parseUNCShare "\\\\/localhost/////\\share" === Nothing)
    ,("getParse parseUNCShare \"//localhost/share\" === Just (UNCShare UnixSep UnixSep (fromList \"localhost\") (fromList [UnixSep]) (fromList \"share\") Nothing)", property $ getParse parseUNCShare "//localhost/share" === Just (UNCShare UnixSep UnixSep (fromList "localhost") (fromList [UnixSep]) (fromList "share") Nothing))
    ,("getParse parseUNCShare \"//localhost/share\" === Just (UNCShare UnixSep UnixSep (fromList \"localhost\") (fromList [UnixSep]) (fromList \"share\") Nothing)", property $ getParse parseUNCShare "//localhost/share" === Just (UNCShare UnixSep UnixSep (fromList "localhost") (fromList [UnixSep]) (fromList "share") Nothing))
    ,("getParse parseUNCShare \"\\\\\\\\localhost/\\\\share\" === Just (UNCShare WindowsSep WindowsSep (fromList \"localhost\") (fromList [UnixSep, WindowsSep]) (fromList \"share\") Nothing)", property $ getParse parseUNCShare "\\\\localhost/\\share" === Just (UNCShare WindowsSep WindowsSep (fromList "localhost") (fromList [UnixSep, WindowsSep]) (fromList "share") Nothing))
    ,("getParse parseUNCShare \"\\\\\\\\localhost/\\\\share\" === Just (UNCShare WindowsSep WindowsSep (fromList \"localhost\") (fromList [UnixSep, WindowsSep]) (fromList \"share\") Nothing)", property $ getParse parseUNCShare "\\\\localhost/\\share" === Just (UNCShare WindowsSep WindowsSep (fromList "localhost") (fromList [UnixSep, WindowsSep]) (fromList "share") Nothing))
    ,("getParse parseUNCShare \"\\\\\\\\localhost\\\\share\\\\my\\\\path.txt::$DATA\" === Just (UNCShare WindowsSep WindowsSep (fromList \"localhost\") (fromList [WindowsSep]) (fromList \"share\") (Just (fromList [WindowsSep], Just (Rel1 (fromList [( fromList \"my\", fromList [WindowsSep])]) (Just (FileName (fromList \"path.txt\") (Just (DS2 (fromList \"$DATA\")))))))))", property $ getParse parseUNCShare "\\\\localhost\\share\\my\\path.txt::$DATA" === Just (UNCShare WindowsSep WindowsSep (fromList "localhost") (fromList [WindowsSep]) (fromList "share") (Just (fromList [WindowsSep], Just (Rel1 (fromList [( fromList "my", fromList [WindowsSep])]) (Just (FileName (fromList "path.txt") (Just (DS2 (fromList "$DATA"))))))))))
    ,("getParse parseUNCShare \"\\\\\\\\localhost\\\\share\\\\my\\\\path.txt::$DATA\" === Just (UNCShare WindowsSep WindowsSep (fromList \"localhost\") (fromList [WindowsSep]) (fromList \"share\") (Just (fromList [WindowsSep], Just (Rel1 (fromList [( fromList \"my\", fromList [WindowsSep])]) (Just (FileName (fromList \"path.txt\") (Just (DS2 (fromList \"$DATA\")))))))))", property $ getParse parseUNCShare "\\\\localhost\\share\\my\\path.txt::$DATA" === Just (UNCShare WindowsSep WindowsSep (fromList "localhost") (fromList [WindowsSep]) (fromList "share") (Just (fromList [WindowsSep], Just (Rel1 (fromList [( fromList "my", fromList [WindowsSep])]) (Just (FileName (fromList "path.txt") (Just (DS2 (fromList "$DATA"))))))))))
    ,("getParse parseRelFilePath \"text.txt\" === Just (Rel2 (FileName (fromList \"text.txt\") Nothing))", property $ getParse parseRelFilePath "text.txt" === Just (Rel2 (FileName (fromList "text.txt") Nothing)))
    ,("getParse parseRelFilePath \"text.txt\" === Just (Rel2 (FileName (fromList \"text.txt\") Nothing))", property $ getParse parseRelFilePath "text.txt" === Just (Rel2 (FileName (fromList "text.txt") Nothing)))
    ,("getParse parseRelFilePath \"baz\\\\foo/bar//text.txt\" === Just (Rel1 (fromList [( fromList \"baz\", fromList [WindowsSep]), (fromList \"foo\", fromList [UnixSep]), (fromList \"bar\", fromList [UnixSep, UnixSep])]) (Just $ FileName (fromList \"text.txt\") Nothing))", property $ getParse parseRelFilePath "baz\\foo/bar//text.txt" === Just (Rel1 (fromList [( fromList "baz", fromList [WindowsSep]), (fromList "foo", fromList [UnixSep]), (fromList "bar", fromList [UnixSep, UnixSep])]) (Just $ FileName (fromList "text.txt") Nothing)))
    ,("getParse parseRelFilePath \"baz\\\\foo/bar//text.txt\" === Just (Rel1 (fromList [( fromList \"baz\", fromList [WindowsSep]), (fromList \"foo\", fromList [UnixSep]), (fromList \"bar\", fromList [UnixSep, UnixSep])]) (Just $ FileName (fromList \"text.txt\") Nothing))", property $ getParse parseRelFilePath "baz\\foo/bar//text.txt" === Just (Rel1 (fromList [( fromList "baz", fromList [WindowsSep]), (fromList "foo", fromList [UnixSep]), (fromList "bar", fromList [UnixSep, UnixSep])]) (Just $ FileName (fromList "text.txt") Nothing)))
    ,("getParse parseRelFilePath \"baz\\\\foo/bar//\" === Just (Rel1 (fromList [( fromList \"baz\", fromList [WindowsSep]), (fromList \"foo\", fromList [UnixSep]), (fromList \"bar\", fromList [UnixSep, UnixSep])]) Nothing)", property $ getParse parseRelFilePath "baz\\foo/bar//" === Just (Rel1 (fromList [( fromList "baz", fromList [WindowsSep]), (fromList "foo", fromList [UnixSep]), (fromList "bar", fromList [UnixSep, UnixSep])]) Nothing))
    ,("getParse parseRelFilePath \"baz\\\\foo/bar//\" === Just (Rel1 (fromList [( fromList \"baz\", fromList [WindowsSep]), (fromList \"foo\", fromList [UnixSep]), (fromList \"bar\", fromList [UnixSep, UnixSep])]) Nothing)", property $ getParse parseRelFilePath "baz\\foo/bar//" === Just (Rel1 (fromList [( fromList "baz", fromList [WindowsSep]), (fromList "foo", fromList [UnixSep]), (fromList "bar", fromList [UnixSep, UnixSep])]) Nothing))
    ,("getParse parseRelFilePath \"\" === Nothing", property $ getParse parseRelFilePath "" === Nothing)
    ,("getParse parseRelFilePath \"\" === Nothing", property $ getParse parseRelFilePath "" === Nothing)
    ,("getParse parseFileName \"text.txt\" === Just (FileName (fromList \"text.txt\") Nothing)", property $ getParse parseFileName "text.txt" === Just (FileName (fromList "text.txt") Nothing))
    ,("getParse parseFileName \"text.txt\" === Just (FileName (fromList \"text.txt\") Nothing)", property $ getParse parseFileName "text.txt" === Just (FileName (fromList "text.txt") Nothing))
    ,("getParse parseFileName \"text.txt::::\" === Just (FileName (fromList \"text.txt::::\") Nothing)", property $ getParse parseFileName "text.txt::::" === Just (FileName (fromList "text.txt::::") Nothing))
    ,("getParse parseFileName \"text.txt::::\" === Just (FileName (fromList \"text.txt::::\") Nothing)", property $ getParse parseFileName "text.txt::::" === Just (FileName (fromList "text.txt::::") Nothing))
    ,("getParse parseFileName \"text.txt::$DATA\" === Just (FileName (fromList \"text.txt\") (Just (DS2 (fromList \"$DATA\"))))", property $ getParse parseFileName "text.txt::$DATA" === Just (FileName (fromList "text.txt") (Just (DS2 (fromList "$DATA")))))
    ,("getParse parseFileName \"text.txt::$DATA\" === Just (FileName (fromList \"text.txt\") (Just (DS2 (fromList \"$DATA\"))))", property $ getParse parseFileName "text.txt::$DATA" === Just (FileName (fromList "text.txt") (Just (DS2 (fromList "$DATA")))))
    ,("getParse parseFileName \"text.txt:type:$DATA\" === Just (FileName (fromList \"text.txt\") (Just (DS1 (fromList \"type\") (Just $ fromList \"$DATA\"))))", property $ getParse parseFileName "text.txt:type:$DATA" === Just (FileName (fromList "text.txt") (Just (DS1 (fromList "type") (Just $ fromList "$DATA")))))
    ,("getParse parseFileName \"text.txt:type:$DATA\" === Just (FileName (fromList \"text.txt\") (Just (DS1 (fromList \"type\") (Just $ fromList \"$DATA\"))))", property $ getParse parseFileName "text.txt:type:$DATA" === Just (FileName (fromList "text.txt") (Just (DS1 (fromList "type") (Just $ fromList "$DATA")))))
    ,("getParse parseFileName \"text.txt:type\" === Just (FileName (fromList \"text.txt\") (Just (DS1 (fromList \"type\") Nothing)))", property $ getParse parseFileName "text.txt:type" === Just (FileName (fromList "text.txt") (Just (DS1 (fromList "type") Nothing))))
    ,("getParse parseFileName \"text.txt:type\" === Just (FileName (fromList \"text.txt\") (Just (DS1 (fromList \"type\") Nothing)))", property $ getParse parseFileName "text.txt:type" === Just (FileName (fromList "text.txt") (Just (DS1 (fromList "type") Nothing))))
    ,("getParse parseFileName \"/text.txt\" === Nothing", property $ getParse parseFileName "/text.txt" === Nothing)
    ,("getParse parseFileName \"/text.txt\" === Nothing", property $ getParse parseFileName "/text.txt" === Nothing)
    ,("getParse parseFileName \"\" === Nothing", property $ getParse parseFileName "" === Nothing)
    ,("getParse parseFileName \"\" === Nothing", property $ getParse parseFileName "" === Nothing)
    ,("getParse parseFileName \"text.txt/\" === Nothing", property $ getParse parseFileName "text.txt/" === Nothing)
    ,("getParse parseFileName \"text.txt/\" === Nothing", property $ getParse parseFileName "text.txt/" === Nothing)
    ,("getParse parseDatastream \"::$DATA\" === Just (DS2 (fromList \"$DATA\"))", property $ getParse parseDatastream "::$DATA" === Just (DS2 (fromList "$DATA")))
    ,("getParse parseDatastream \"::$DATA\" === Just (DS2 (fromList \"$DATA\"))", property $ getParse parseDatastream "::$DATA" === Just (DS2 (fromList "$DATA")))
    ,("getParse parseDatastream \":type:$DATA\" === Just (DS1 (fromList \"type\") (Just $ fromList \"$DATA\"))", property $ getParse parseDatastream ":type:$DATA" === Just (DS1 (fromList "type") (Just $ fromList "$DATA")))
    ,("getParse parseDatastream \":type:$DATA\" === Just (DS1 (fromList \"type\") (Just $ fromList \"$DATA\"))", property $ getParse parseDatastream ":type:$DATA" === Just (DS1 (fromList "type") (Just $ fromList "$DATA")))
    ,("getParse parseDatastream \":type\" === Just (DS1 (fromList \"type\") Nothing)", property $ getParse parseDatastream ":type" === Just (DS1 (fromList "type") Nothing))
    ,("getParse parseDatastream \":type\" === Just (DS1 (fromList \"type\") Nothing)", property $ getParse parseDatastream ":type" === Just (DS1 (fromList "type") Nothing))
    ,("getParse parseDatastream \":\" === Nothing", property $ getParse parseDatastream ":" === Nothing)
    ,("getParse parseDatastream \":\" === Nothing", property $ getParse parseDatastream ":" === Nothing)
    ,("getParse parseDatastream \"::\" === Nothing", property $ getParse parseDatastream "::" === Nothing)
    ,("getParse parseDatastream \"::\" === Nothing", property $ getParse parseDatastream "::" === Nothing)
    ,("getParse parseDatastream \"lol\" === Nothing", property $ getParse parseDatastream "lol" === Nothing)
    ,("getParse parseDatastream \"lol\" === Nothing", property $ getParse parseDatastream "lol" === Nothing)
    ,("getParse parseDatastream \"\" === Nothing", property $ getParse parseDatastream "" === Nothing)
    ,("getParse parseDatastream \"\" === Nothing", property $ getParse parseDatastream "" === Nothing)
    ]
