...
import "os-string" System.OsString.Data.ByteString.Short ( toShort )
import "os-string" System.OsString.Posix as PosixS hiding (map)
import "os-string" System.OsString.Windows as WindowsS hiding (map)
